...
rf10d1 <- "../405_project/rawCounts/10d1ReadsPerGene.out.tab"
rf10d2 <- "../405_project/rawCounts/10d2ReadsPerGene.out.tab"
rf10d3 <- "../405_project/rawCounts/10d3ReadsPerGene.out.tab"
apod1 <- "../405_project/rawCounts/apo1ReadsPerGene.out.tab"
apod2 <- "../405_project/rawCounts/apo2ReadsPerGene.out.tab"
apod3 <- "../405_project/rawCounts/apo3ReadsPerGene.out.tab"
